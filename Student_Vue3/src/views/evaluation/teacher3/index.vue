<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="评价人工号" prop="nameId">
        <el-input
          v-model="queryParams.nameId"
          placeholder="请输入评价人工号"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="teacherList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="评价人工号" align="center" prop="nameId" />
...
import { listTeacher, getTeacher, delTeacher, addTeacher, updateTeacher } from "@/api/evaluation/teacher3"
