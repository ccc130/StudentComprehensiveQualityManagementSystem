 ...
 */
@RestController
@RequestMapping("/evaluation/teacher2")
public class EvaluationTeacher2Controller extends BaseController
{
    @Autowired
    ...
    @GetMapping("/islist")
    public List<EvaluationTeacher> selectEvaluationTeacherByIsevaluation()
    {
        List<EvaluationTeacher> evaluationTeacher = evaluationTeacherService.selectEvaluationTeacherByIsevaluation(0);
        String createAccount = SecurityUtils.getUsername();
        evaluationTeacher.removeIf(item -> !item.getTargetId().equals(createAccount));
